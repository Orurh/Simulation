...
class ServiceProvider:
    ...
    def __init__(self, world, game_config: GameConfig):
        ...
        self.predator_transformation_service = PredatorTransformationService(self.world, self.game_config.speed_of_predator, self.game_config.hp_of_predator)
        self.consumption_service = ConsumptionService(self.world, self.predator_transformation_service, self.entity_creation_service)
